...
INSERT OR REPLACE INTO jobs_fts (rowid, objectID, url, name, location, published_date, company_slug, company_title)
VALUES (new.rowid, new.objectID, new.url, new.name, new.location, new.published_date, new.company_slug, new.company_title);
END;
